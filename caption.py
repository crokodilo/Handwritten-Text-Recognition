...
def visualize_att(image_path, seq, alphas, tokenizer, smooth=True):
    ...
    for t in range(len(words)):
        ...
        plt.text(0, -15, '%s' % (words[t]), color='black', backgroundcolor='white', fontsize=6)
        plt.imshow(image)
        ...
        plt.axis('off')
    plt.tight_layout()
    plt.savefig('test-imgs/attention2.png')
    print('DONE!')
    #plt.show()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img', '-i', default='test-imgs/train-31.png', help='path to image')
    ...
    seq, alphas = caption_image_beam_search(encoder, decoder, args.img, tokenizer, args.beam_size)
